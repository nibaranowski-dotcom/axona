...
| 20  | E4   | LAUNCH.3 | design-critique gate vs linear/harvey bar; anti-slop check; Railway deploy [human-gate]          | P0  | M    | todo   | LAUNCH.1, LAUNCH.2 |
...
CPRD "20E4WebLAUNCH.3design-critique gate vs linear/harvey bar; anti-slop; Railway deployP0Mtodo3Needs LAUNCH.1+2"
```
