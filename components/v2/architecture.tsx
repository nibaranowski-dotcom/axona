...
// and the primitives every workflow is built from. Then the verticals (humanoids
// first → carried to every robot company).
export function Architecture() {
  return (
    <section
      id="platform-architecture"
      className="mx-auto max-w-[1180px] px-7 py-[88px]"
    >
      <div className="flex flex-wrap items-end justify-between gap-5">
        ...
        <p className="max-w-[36ch] text-[15px] leading-[1.5] text-[--body]">
          {architecture.intro}
        </p>
      </div>
      ...
      <div className="mt-11 flex flex-col gap-2.5">
        {architecture.layers.map((l) => (
          ...
          >
            <div className="min-w-[230px] font-mono text-[11px] tracking-[0.06em] text-[--body]">
              {l.tag}
            </div>
            <div className="min-w-[240px] flex-1">
              ...
              <p className="mt-1.5 max-w-[74ch] text-[14px] leading-[1.45] text-[--body]">
                {l.body}
              </p>
            </div>
          </div>
