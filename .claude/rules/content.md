# Rule: Content & integrity (applies to content/**, specs/content/**)
...
- **Content integrity (inherited from ../CLAUDE.md):** never invent traction, customers, logos,
  ...
  rendered as clearly-marked mock/sample UI. Named partners/customers require Nicolas's sign-off.
- Every claim reconciles to `../memory/` (idea, icp, competition, market, people). Flag conflicts.
- Email capture copy sets honest expectations (what happens after you submit, who replies).
